...
Please note: Tables created using the 'run_sql' via /v2/query will not be auto-tracked in the Hasura dashboard, you must navigate to the dashboard and click on "Track" table to display it in the tree.
